...
(() => {
  try {
    ...
    // Umi UI Bubble
    require('../../../../../../../usr/local/lib/node_modules/umi/node_modules/umi-plugin-ui/lib/bubble').default(
      {
        port: 3001,
        path: '/Users/fengmin/person/umi-test',
        currentProject: '',
        isBigfish: undefined,
      },
    );
...
(() => {
  ...
  window.GUmiUIFlag = require('../../../../../../../usr/local/lib/node_modules/umi/node_modules/umi-build-dev/lib/plugins/commands/block/sdk/flagBabelPlugin/GUmiUIFlag.js').default;
